...
/// </summary>
public sealed record ChangeResult : CommandResultBase
{
    private ChangeResult()
    {
    }

    private ChangeResult(DomainError error) : base(error)
    {
    }

    private ChangeResult(Exception panicException) : base(panicException)
    {
    }
    ...
    /// Factory for success.
    /// </summary>
    public static ChangeResult Success { get; } = new();
    ...
    /// <returns></returns>
    public static ChangeResult DomainFail(DomainError error) => new(error);
    ...
    /// <returns></returns>
    public static ChangeResult PanicFail(Exception panicException) => new(panicException);
    ...
    /// <returns></returns>
    public static implicit operator bool(ChangeResult result) => result.IsSuccess;
