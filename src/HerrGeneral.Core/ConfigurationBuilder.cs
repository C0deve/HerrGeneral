...
public class ConfigurationBuilder
{
    ...
    /// </summary>
    private readonly CommandHandlerMappings _commandHandlerMappings  = new();
    ...
    public ConfigurationBuilder ScanReadSideOn(Assembly assembly, params string[] namespaces)
    {
    ...
    /// <param name="namespaces">Optional list of namespaces to limit the search. If not specified, the entire assembly will be scanned.</param>
    /// <returns>The current Configuration instance to enable fluent method chaining.</returns>
    public ConfigurationBuilder ScanWriteSideOn(Assembly assembly, params string[] namespaces)
    {
