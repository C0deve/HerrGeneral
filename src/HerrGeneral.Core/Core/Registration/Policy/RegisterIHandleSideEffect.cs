...
/// <summary>
/// Registers all handlers on read side that implement <see cref="IHandleSideEffect{TEvent}"/>.
/// </summary>
internal class RegisterIHandleSideEffect : IRegistrationPolicy
{
    private readonly Type _handlerInterface = TypeDefinition.SideEffectHandlerInterface;
