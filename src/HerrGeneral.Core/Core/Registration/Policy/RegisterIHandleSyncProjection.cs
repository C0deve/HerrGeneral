...
/// <summary>
/// Registers all handlers on write side that implement <see cref="IHandleSyncProjection{TEvent}"/>.
/// </summary>
internal class RegisterIHandleSyncProjection : IRegistrationPolicy
{
    private readonly Type _handlerInterface = TypeDefinition.SyncProjectionHandlerInterface;
