...
internal class RegisterIHandleCrossAggregate : IRegistrationPolicy
{
    private readonly Type _handlerInterface = typeof(IHandleCrossAggregate<,>);
    ...
    private static void RegisterEventHandlerServices(IServiceCollection serviceCollection, Type[] genericArguments, Type externalWriteSideEventHandler)
    {
        ...
        var internalHandler = typeof(CrossAggregateChangeHandlerInternal<,,>).MakeGenericType(eventType, externalWriteSideEventHandler, aggregateType);
