...
{
    private readonly Type _handlerInterface = typeof(IChangeMultiHandler<,>);
    ...
    public void Register(IServiceCollection serviceCollection, Dictionary<Type, HashSet<Type>> externalHandlersProvider)
    {
        ...
        foreach (var externalCommandHandler in externalHandlers)
        {
            ...
            var internalHandler = typeof(ChangeMultiHandlerInternal<,,>).MakeGenericType(genericArguments[0], genericArguments[1], externalCommandHandler);
