...
public class AProjection : Projection<AProjectionItem>,
    ReadSide.IProjectionEventHandler<TheThingIsCreated>,
    ReadSide.IProjectionEventHandler<TheThingNameChanged>,
    ReadSide.IProjectionEventHandler<TheThingDeleted>
{
